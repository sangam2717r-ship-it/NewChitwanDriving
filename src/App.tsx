...
const t = {
  en: {
    ...
    edu_subtitle:
      "Essential knowledge for your Likhit (Written) exam and daily driving.",
    team_title: "Our Team",
    ...
    likhit_desc:
      "Attempt our infinite question pool based on the official 500 Question Collection.",
  ...
  np: {
    ...
    history_desc:
      "राणा प्रधानमन्त्रीहरूले भित्र्याएको पहिलो कार देखि आजका आधुनिक राजमार्गहरूसम्म, नेपालको सवारी इतिहास लामो छ।",
...
const quizQuestions = [
  ...
  },
  {
    ...
    options: [
      ...
      { en: "Traffic jams", np: "ट्राफिक जाममा" },
    ],
    correct: 1,
  },
  {
    id: 5,
    q: {
      en: "What does a continuous white line mean?",
      np: "सडकको बीचमा निरन्तर सेतो रेखाले के जनाउँछ?",
    },
    options: [
      { en: "Overtake allowed", np: "ओभरटेक गर्न मिल्छ" },
      { en: "Do not cross the line", np: "रेखा काट्न पाइदैन" },
      { en: "Parking allowed", np: "पार्किङ गर्न मिल्छ" },
      { en: "Stop", np: "रोक्नुहोस्" },
    ],
    correct: 1,
  },
  {
    id: 6,
    q: {
      en: "What is the speed limit in city areas usually?",
      np: "सहरी क्षेत्रमा सामान्यतया गति सीमा कति हुन्छ?",
    },
    options: [
      { en: "40 km/h", np: "४० कि.मि./घण्टा" },
      { en: "60 km/h", np: "६० कि.मि./घण्टा" },
      { en: "80 km/h", np: "८० कि.मि./घण्टा" },
      { en: "No limit", np: "कुनै सीमा छैन" },
    ],
    correct: 0,
  },
  {
    id: 7,
    q: {
      en: "Which gear should be used while going downhill?",
      np: "ओरालो झर्दा कुन गियर प्रयोग गर्नुपर्छ?",
    },
    options: [
      { en: "Neutral", np: "न्युट्रल" },
      { en: "Top Gear", np: "टप गियर" },
      { en: "Low Gear", np: "लो (Low) गियर" },
      { en: "Clutch pressed", np: "क्लच थिचेर" },
    ],
    correct: 2,
  },
  {
    ...
    q: {
      ...
      np: "झिमिक-झिमिक गर्ने पहेंलो बत्तीले के जनाउँछ?",
    },
    options: [
      { en: "Stop immediately", np: "तुरुन्त रोक्नुहोस्" },
      { en: "Proceed with caution", np: "होसियारीपूर्वक अगाडि बढ्नुहोस्" },
      { en: "Go fast", np: "छिटो जानुहोस्" },
      { en: "Parking", np: "पार्किङ" },
    ],
    correct: 1,
  },
];
        ...
        <div className="fixed inset-0 bg-black/60 z-50 flex items-center justify-center p-4 animate-fade-in">
          <div className="bg-white rounded-xl p-6 w-full max-w-sm shadow-2xl">
            ...
            <div className="grid grid-cols-3 gap-2 max-h-60 overflow-y-auto">
              {timeSlots.map((t) => (
                <button
                  ...
                  className="p-2 border rounded hover:bg-red-50 hover:border-red-500 text-xs font-bold transition"
                >
                  {t}
                </button>
              ))}
            ...
            <button
              ...
              className="mt-4 w-full py-3 bg-gray-100 rounded-lg text-sm font-bold text-gray-600"
            >
              Cancel
            </button>
          </div>
      ...
      <div className="bg-white border rounded-lg p-4 shadow-sm mb-4">
            ...
            .map((_, i) => {
              ...
              return (
                <div
                  ...
                  className={`h-9 w-9 flex items-center justify-center rounded-full text-sm font-medium cursor-pointer transition-all ${
                    isSelected
                      ? "bg-green-600 text-white shadow-md scale-105 ring-2 ring-green-100"
        ...
        <div className="mt-4 flex justify-between items-center bg-gray-50 p-2 rounded text-xs font-bold text-gray-600">
          <span>
            ...
            <span
              className={
                selectedCount === targetDays ? "text-green-600" : "text-red-600"
              }
            >
              {selectedCount}
            </span>{" "}
          ...
          <div className="space-y-1">
            {Object.entries(schedule)
              ...
              .map(([date, time]) => (
                <div
                  key={date}
                  className="flex justify-between text-sm bg-white p-2 rounded border border-gray-100 shadow-sm"
                >
                  <span className="font-medium text-gray-700">{date}</span>
                  <span className="font-bold text-green-600">{time}</span>
                </div>
              ))}
          </div>
        </div>
...
const Sign = ({ type, icon, label, sub }: any) => {
  return (
    <div className="flex flex-col items-center mb-4">
      ...
      {type === "mandatory" && (
        <div className="w-20 h-20 relative">
          <svg viewBox="0 0 100 100" className="w-full h-full drop-shadow-md">
            ...
            {icon === "NO_ENTRY" && (
              <path d="M30 50 L70 50" stroke="black" strokeWidth="10" />
            )}
            {icon === "NO_PARKING" && (
              <>
                <text
            ...
            {icon === "NO_HORN" && (
              <>
                <text x="50" y="60" fontSize="30" textAnchor="middle">
                  🎺
                </text>
                <line
                  x1="25"
            ...
            {icon === "LEFT" && (
              <path
                d="M60 30 L35 50 L60 70 M35 50 L75 50"
                stroke="black"
                strokeWidth="8"
                fill="none"
                strokeLinecap="round"
        ...
        <div className="w-20 h-20 relative flex items-center justify-center">
          <svg viewBox="0 0 100 90" className="w-full h-full drop-shadow-md">
            ...
            <g transform="translate(50, 55)">
              {icon === "CROSS" && (
                <text x="0" y="10" fontSize="35" textAnchor="middle">
                  🦓
                </text>
              )}
              {icon === "LIGHT" && (
      ...
      {type === "info" && (
        <div className="w-20 h-20 relative">
          <svg viewBox="0 0 100 100" className="w-full h-full drop-shadow-md">
            ...
            {icon === "FUEL" && (
              <text x="50" y="65" fontSize="40" textAnchor="middle">
                ⛽
              </text>
            )}
            {icon === "TOOL" && (
      ...
      <p className="mt-2 text-xs font-bold text-gray-700 text-center leading-tight">
        {label}
      </p>
        ...
        <div className="flex justify-between items-center h-16">
          ...
          <div className="hidden md:flex items-center space-x-1">
            ...
            <button
              ...
              className="ml-4 px-3 py-2 bg-red-950 rounded-full hover:bg-black border border-red-800"
            >
          ...
          <div className="md:hidden flex items-center gap-4">
            <button
              onClick={() => setLang(lang === "en" ? "np" : "en")}
              className="bg-red-950 px-3 py-1 rounded-full text-xs font-bold border border-red-800"
            >
              {lang === "en" ? "NP" : "EN"}
            </button>
            <button
              onClick={() => setIsOpen(!isOpen)}
              className="text-red-100 p-2"
            >
              {isOpen ? <X /> : <Menu />}
            </button>
          </div>
        ...
        <div className="md:hidden bg-red-800 border-t border-red-700 p-2">
          {navItems.map((i) => (
            <button
              ...
              className="block w-full text-left px-3 py-3 rounded-md text-base font-medium text-red-100 hover:bg-red-700"
            >
              {i.l}
            </button>
          ))}
...
const QuizView = ({ lang, setView }: any) => {
  ...
  const handleAnswer = (optionIndex: number) => {
    ...
    if (!isPracticeMode) {
      if (optionIndex === shuffledQuestions[currentQ].correct)
        setScore(score + 1);
      setTimeout(() => {
  ...
  return (
    <div className="max-w-lg mx-auto p-4 my-8">
      <div className="bg-white rounded-xl shadow-lg overflow-hidden border border-gray-200 relative">
        <button
          onClick={() => setView("home")}
          className="absolute top-4 right-4 text-white hover:text-red-200 z-10 font-bold flex items-center gap-1"
        >
        ...
        <div className="p-6">
          ...
          <div className="mt-6 flex gap-2">
            <button
              ...
              disabled={currentQ === 0}
              className="flex-1 py-3 border border-gray-300 rounded-lg font-bold text-gray-500 disabled:opacity-50 flex items-center justify-center gap-1"
            >
            ...
            {isPracticeMode && selectedOption !== null && (
              <button
                ...
                className="flex-[2] py-3 bg-slate-800 text-white rounded-lg font-bold flex items-center justify-center gap-2"
              >
  ...
  return (
    <div className="max-w-4xl mx-auto px-6 py-12 animate-fade-in select-none">
      ...
      <div className="space-y-12">
        <div>
          <h3 className="text-xl font-bold text-red-700 mb-4 border-b pb-2 flex items-center gap-2">
            <AlertOctagon className="w-5 h-5" /> {T.signs_mandatory}
          </h3>
          <div className="grid grid-cols-3 md:grid-cols-6 gap-4">
            <Sign type="mandatory" icon="STOP" label="Stop" />
            <Sign type="mandatory" icon="NO_ENTRY" label="No Entry" />
            <Sign type="mandatory" icon="LEFT" label="Left Only" />
        ...
        <div>
          <h3 className="text-xl font-bold text-yellow-600 mb-4 border-b pb-2 flex items-center gap-2">
            <AlertTriangle className="w-5 h-5" /> {T.signs_warning}
          </h3>
          <div className="grid grid-cols-3 md:grid-cols-6 gap-4">
            <Sign type="warning" icon="LIGHT" label="Traffic Light" />
            <Sign type="warning" icon="CROSS" label="Zebra Cross" />
            <Sign type="warning" icon="SCHOOL" label="School" />
            <Sign type="warning" icon="BEND" label="Left Bend" />
            <Sign type="warning" icon="HILL" label="Steep Hill" />
            <Sign type="warning" icon="HAZARD" label="Hazard" />
          </div>
        </div>

        <div>
          <h3 className="text-xl font-bold text-blue-600 mb-4 border-b pb-2 flex items-center gap-2">
            <Info className="w-5 h-5" /> {T.signs_info}
          </h3>
          <div className="grid grid-cols-3 md:grid-cols-6 gap-4">
            <Sign type="info" icon="P" label="Parking" />
            <Sign type="info" icon="H" label="Hospital" />
            <Sign type="info" icon="FUEL" label="Fuel" />
            <Sign type="info" icon="TOOL" label="Workshop" />
          </div>
        </div>
      </div>
    </div>
...
const AdminPanel = ({
  ...
  const openEdit = (b: any) => {
    setEditingBooking(b);
    setEditSchedule(parseSchedule(b.date));
  };

  const handleSaveBookingEdit = async () => {
    if (!editingBooking) return;
    const dateString = Object.entries(editSchedule)
      .sort()
      .map(([d, t]) => `${d} @ ${t}`)
      .join("\n");
    await updateDoc(
  ...
  const handleAddPrivate = async () => {
    ...
    const dateString = Object.entries(pSchedule)
      .sort()
      .map(([d, t]) => `${d} @ ${t}`)
      .join("\n");
    await addDoc(
                    ...
                    <div className="flex justify-between items-start mb-2">
                      <div>
                        ...
                        <div className="flex items-center gap-2 mt-1">
                          <p className="text-xs font-bold text-blue-600 bg-blue-50 p-1 rounded break-words max-w-xs whitespace-pre-wrap">
                            {b.date}
                          </p>
                          <button
                            onClick={() =>
          ...
          {adminTab === "private" && (
            <div className="max-w-md space-y-4">
              ...
              <div className="border p-2 rounded">
                {" "}
                <p className="text-xs font-bold mb-2">Select Dates:</p>
                <CustomCalendar
                  schedule={pSchedule}
                  setSchedule={setPSchedule}
                  targetDays={100}
                />{" "}
              </div>
              <textarea
                placeholder="Notes (e.g. Cash Paid)"
                className="w-full p-2 border rounded"
                value={pNotes}
