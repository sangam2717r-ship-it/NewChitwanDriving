...
const dictionary: { [key: string]: { [key: string]: string } } = {
  en: {
    ...
    "Prem Sir will review your request shortly.":
      "Prem Sir will review your request shortly.",
    Select: "Select",
    Days: "Days",
    "Choose Date": "Choose Date",
    "No booking found for this number.": "No booking found for this number.",
    "No active (approved) booking found for this number.":
    ...
    "Please select dates for the booking.":
      "Please select dates for the booking.",
    "Please select a time for every selected date.":
      "Please select a time for every selected date.",
    "Private Booking Added to Active Schedule!":
      "Private Booking Added to Active Schedule!",
    ...
    "Question/Answer must be long enough.":
      "Question/Answer must be long enough.",
  ...
  ne: {
    ...
    "Verify & Submit": "बुकिङ निश्चित गर्नुहोस्",
    "Verifying...": "बचत गर्दै...",
    ...
    "Continue to Verification": "अगाडि बढ्नुहोस्",
    ...
    "Notes (e.g. Family Discount, Cash Paid)":
      "नोटहरू (जस्तै: पारिवारिक छुट, नगद भुक्तानी)",
    "Name Required": "नाम आवश्यक छ",
    "Please select dates for the booking.":
      "कृपया बुकिङका लागि मितिहरू छान्नुहोस्।",
    "Please select a time for every selected date.":
      "कृपया प्रत्येक छानिएको मितिको लागि समय छान्नुहोस्।",
    "Private Booking Added to Active Schedule!":
      "निजी बुकिङ सक्रिय तालिकामा थपियो!",
    "Price (Override)": "मूल्य (परिवर्तन गर्नुहोस्)",
    "Error removing booking: ": "बुकिङ हटाउँदा त्रुटि: ",
    "Your driving course is confirmed!": "तपाईंको ड्राइभिङ कोर्स पक्का भयो!",
    Package: "प्याकेज",
    Location: "स्थान",
    "Please arrive 5 minutes early for your first session.":
      "कृपया आफ्नो पहिलो सत्रको लागि ५ मिनेट अगाडि आउनुहोस्।",
    Namaste: "नमस्ते",
    Sunday: "आइतबार",
    Monday: "सोमबार",
    Tuesday: "मंगलबार",
    ...
    Fri: "शुक्र",
    Sat: "शनि",
    "Other / Any Available": "अन्य / जो उपलब्ध छ",
    "Delete this?": "के यो मेटाउने?",
    "Active Schedule": "सक्रिय तालिका",
    "Question/Answer must be long enough.":
      "प्रश्न/उत्तर पर्याप्त लामो हुनुपर्छ।",
    "Security Question/Answer Updated!": "सुरक्षा प्रश्न/उत्तर अपडेट गरियो!",
    "Database not ready": "डाटाबेस तयार छैन",
    "Error saving: ": "बचत गर्दा त्रुटि: ",
    "Check My Progress": "मेरो प्रगति हेर्नुहोस्",
    "Saving...": "बचत गर्दै...",
  },
};
...
const CalendarPicker = ({
  ...
  const monthDetails = useMemo(
    () => getMonthDetails(currentYear, currentMonth, lang),
  ...
  const getDayClass = (day: number) => {
    ...
    if (!isPrivate && isPast) {
      // Only restrict past days for public view
      className +=
      ...
      <div className="min-h-[500px] flex items-center justify-center bg-white rounded-xl shadow-xl p-8 text-center animate-fade-in select-none">
        <div className="max-w-md">
          ...
          <p className="text-slate-600 mb-6">
            {T("Prem Sir will review your request shortly.", lang)}
          </p>
          <button
            onClick={() => {
              setStep("customize");
                ...
                >
                  <div className="flex justify-between items-start mb-2">
                    ...
                    <div className="text-right">
                      ...
                      {booking.courseDates &&
                        booking.courseDates.length > 1 && (
                          <button
                            className="text-xs bg-white border border-slate-300 px-2 py-1 rounded shadow-sm text-slate-600"
                            onClick={() =>
                              alert(
                                "Schedule:\n" +
                                  booking.courseDates
