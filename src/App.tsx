            ...
            <div className="space-y-8">
              ...
              <div className="bg-white p-6 rounded-xl shadow-sm">
                <h2 className="text-lg font-bold mb-4 flex items-center gap-2">
                  <Settings className="h-5 w-5" /> Update Rates
                </h2>
                <div className="space-y-3">
                  <div>
                    ...
                    <input
                      ...
                      onChange={(e) =>
                        setSettings({ ...settings, bikeRate: e.target.value })
                      }
                      className="w-full border p-2 rounded"
                    />
                  </div>
                  <div>
                    ...
                    <input
                      value={settings.scooterRate}
                      onChange={(e) =>
                        setSettings({
                          ...settings,
                          scooterRate: e.target.value,
                        })
                      }
                      className="w-full border p-2 rounded"
                    />
              ...
              <div className="bg-white p-6 rounded-xl shadow-sm">
                <h2 className="text-lg font-bold mb-4 flex items-center gap-2">
                  <Plus className="h-5 w-5" /> Manual Booking
                </h2>
      ...
      >
        ...
        <div className="max-w-7xl mx-auto px-4 relative z-10 text-center">
          ...
          <p className="text-xl md:text-2xl mb-8 text-blue-100 max-w-2xl mx-auto">
            Professional instructors in Chitwan.
          </p>
          <a
            href="#book"
          ...
          <form onSubmit={handleSubmitBooking} className="p-6 md:p-8 space-y-5">
            ...
            <div className="grid grid-cols-2 gap-4">
              <div>
                ...
                <select
                  name="bloodGroup"
                  className="w-full px-3 py-3 rounded-lg border border-gray-300 bg-white"
            ...
            <div>
              ...
              <select
                ...
                onChange={handleInputChange}
              >
                <option value="Bike Trial">
                  Bike Trial (Rs. {settings.bikeRate})
                </option>
                <option value="Scooter Trial">
                  Scooter Trial (Rs. {settings.scooterRate})
                </option>
