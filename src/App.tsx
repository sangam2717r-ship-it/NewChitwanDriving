        ...
        <div className="p-8 flex flex-col items-center justify-center h-full">
          ...
          {myBooking && (
            <div className="bg-gray-50 border border-gray-200 rounded-xl p-6 w-full max-w-md">
              ...
              <div className="text-center p-3 bg-white rounded border border-gray-200 text-sm break-words">
                {myBooking.date}
              </div>
            </div>
          )}
...
const AdminPanel = ({
  ...
  const handleSaveBookingEdit = async () => {
    ...
    const dateString = editingBooking.dateInput
      ? `${editingBooking.dateInput} @ ${editingBooking.timeInput || "Any"}`
      : editingBooking.newDate;
    await updateDoc(
      doc(
        db,
        "artifacts",
                    ...
                    <div className="flex justify-between items-start mb-2">
                      <div>
                        ...
                        <div className="flex items-center gap-2 mt-1">
                          <p className="text-xs font-bold text-blue-600 bg-blue-50 p-1 rounded break-words max-w-xs">
                            {b.date}
                          </p>
                          <button
                            onClick={() =>
